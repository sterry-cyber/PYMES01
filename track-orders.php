	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Seguimiento de tu pedido</li>
			</ul>
...
<div class="body-content outer-top-bd">
	...
	<span class="title-tag inner-top-vs">Por favor, ingresa tu ID de Pedido en el cuadro de abajo y presiona Enter. Este ID fue proporcionado en tu recibo y en el correo de confirmación que deberías haber recibido. </span>
	<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
		<div class="form-group">
		    <label class="info-title" for="exampleOrderId1">ID de Pedido</label>
