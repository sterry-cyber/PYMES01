...
echo "<script>alert('Producto añadido a la lista de Deseo');</script>";
...
{?>							
	...
	<div class="product">		
				...
				<div class="action">
					...
					<?php } ?>
		                ...
		                <li class="lnk wishlist">
							<a class="add-to-cart" href="category.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist" title="Lista de deseo">
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>No se encontraron producto</h3>
		</div>
