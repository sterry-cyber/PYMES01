...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingrese el Nombre de la Compañía" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="control-group">
<label class="control-label" for="basicinput">Cargo de Envío del Producto</label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingrese el Cargo de Envío del Producto" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imágenes del Producto</label>
<div class="controls">
