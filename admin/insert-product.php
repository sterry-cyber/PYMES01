...
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Ingrese el nombre de la compañía del producto" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Ingrese el cargo de envío del producto" class="span8 tip" required>
</div>
</div>
