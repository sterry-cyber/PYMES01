...
$_SESSION['msg']="Sub-Categoria Actualizado !!";
...
<div class="controls">
<input type="text" placeholder="Ingrese el nombre de la categoría"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
</div>
</div>
