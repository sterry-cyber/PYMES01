...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Marca del Prod :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="http://facebook.com/tuperfil"></a></li>
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Calidad :</b>  <?php echo htmlentities($rvw['quality']);?> Estrellas(s)</div>
													<div class="text"><b>Precio :</b>  <?php echo htmlentities($rvw['price']);?> Estrellas(s)</div>
													<div class="text"><b>Valor :</b>  <?php echo htmlentities($rvw['value']);?> Estrellas(s)</div>
											...
											<div class="review-form">
												<div class="form-container">
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Reseñas <span class="astk">*</span></label>
