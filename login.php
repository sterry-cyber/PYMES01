...
<html lang="en">
	<head>
	    ...
	    <title> Portal | Iniciar sesion | Registrarse</title>
...
?>
		...
		<div class="form-group">
		    <label class="info-title" for="exampleInputEmail1">Direccion de Correo Electronico <span>*</span></label>
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle">Crea una nueva cuenta</h4>
...
<div class="form-group">
		...
		<div class="form-group">
	    	<label class="info-title" for="exampleInputEmail2">Correo electronica <span>*</span></label>
...
<div class="form-group">
	...
	<span class="checkout-subtitle outer-top-xs">Registrate hoy y podras :  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		Acekarar tu proceso de pago.
		</label>
		<label class="checkbox">
		Rastrear tus pedidos facilmente.
		</label>
		<label class="checkbox">
